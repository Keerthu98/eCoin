        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.mail),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("vicky@admin.com"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.mail),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText2.perform(replaceText("vicky"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.mail),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("vicky@admin.com"), closeSoftKeyboard());
